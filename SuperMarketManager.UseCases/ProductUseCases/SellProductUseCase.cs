...
public class SellProductUseCase : ISellProductUseCase
{
    ...
    public SellProductUseCase(IProductRepository productRepository, ITransactionRepository transactionRepository, IRecordTransactionUseCase recordTransactionUseCase)
    {
